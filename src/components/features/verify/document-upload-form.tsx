...
// =============================================================================
// DocumentUploadForm — client component for verify/documents gate
// =============================================================================

interface RejectionInfo {
  reason: string; // locale-resolved rejection reason
}
...
export function DocumentUploadForm({ rejection }: DocumentUploadFormProps) {
        ...
        {rejection && (
          <div className="flex items-start gap-3 rounded-lg border border-destructive/30 bg-destructive/5 p-4">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-medium text-destructive">{t('rejectedTitle')}</p>
              <p className="mt-1 text-sm text-muted-foreground">{rejection.reason}</p>
              <p className="mt-2 text-xs text-muted-foreground">{t('rejectedReupload')}</p>
            </div>
          </div>
        )}
