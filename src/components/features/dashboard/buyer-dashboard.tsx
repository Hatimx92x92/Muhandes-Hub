// =============================================================================
// Buyer Dashboard — free role, focused on RFQs, deals, inquiries
// =============================================================================
...
export function BuyerDashboard({
  ...
  const stats = [
    ...
    { label: tStats('quotations'), value: counts.quotations ?? 0, icon: ShoppingCart, href: '/dashboard/quotations' },
  ...
  const quickActions = [
    ...
    { label: tActions('viewDeals'), href: '/dashboard/deals', icon: Handshake },
  ];
